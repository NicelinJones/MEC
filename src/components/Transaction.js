 ...
 function Transaction(){
  ...
  <div className='lib'>
    ...
    <div className='df'>
      ...
      <h2>Amount</h2>
      <input type="number" placeholder='Enter Amount..' value={amount1} name ='Income' onChange={e => setAmount(e.target.value)}/>
      <div><br></br>
      ...
      <select name='Expense' value={seluct} onChange= {e => setSeluct(e.target.value)}>
        ...
        <h2>Amount</h2>
      <input type="number" placeholder='Enter Amount..' value={amount2} name ='Expense' onChange={e => setAmount(-(e.target.value))}/>   
      <div>
